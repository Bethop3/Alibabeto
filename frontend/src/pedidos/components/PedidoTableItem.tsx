...
import EstadoPedidoLabel from "../components/EstadoPedidoLabel"

const PedidoTableItem = ({ id, fechaPedido, importe, iva, total, estadoPedido }: any) => {
    ...
    const fechaFormateada = formatter.format(new Date(fechaPedido));
        ...
        <tr>
            ...
            <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center gap-x-6">
                    <Link to={`/mis_pedidos/${id}`} className="bg-alibabeto-1 py-2 px-6 text-white rounded-lg transition-colors duration-200 focus:outline-none">
                        Ver
                    </Link>
