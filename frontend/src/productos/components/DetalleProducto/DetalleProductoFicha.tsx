...
const DetalleProductoFicha: FC = () => {
    ...
    const { codigo, descripcion, precio, titulo } = producto!
    ...
    return (
        <>
            ...
            <div className="w-full h-full mx-auto">
                ...
                <p className='text-justify font-semibold opacity-50'>
                    {
                        codigo
                    }
                </p>
                ...
                <button
                    ...
                    disabled={isLoading || isLoadingCarrito}
                    className={
                        `
                        ${isLoading || isLoadingCarrito ? 'opacity-50 py-3' : ''}
                ...
                <div className='my-5'>
                    ...
                    <h3 className='font-bold text-xl mb-2'>Detalles del producto</h3>
...
export default DetalleProductoFicha