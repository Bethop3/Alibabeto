...
const Paginacion = () => {
    ...
    const { handleNextPage, handlePrevPage, totalPaginas, changePage, pagina } = useContext(BuscadorProductosContext)!
    ...
    return (
        <nav className='mt-10 mx-auto flex justify-center' aria-label="Page navigation example">
