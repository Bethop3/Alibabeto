...
const AdminUsuariosCreatePage = () => {

    const { submit, isLoading, register, errors } = useCreateUsuario()
            ...
            <div className="rounded-lg mx-auto bg-white max-w-[50%] border p-5">
                <form onSubmit={submit} noValidate>
                    <div className="grid gap-6 mb-6 lg:grid-cols-1">
                        ...
                        <h2 className="text-3xl font-bold">Crear tu usuario</h2>
...
export default AdminUsuariosCreatePage