...
const AdminProductoCreatePage = () => {

    const { register, handleSubmit, formState: { errors } } = useForm<InputsCreateProducto>();
    ...
    const { onSubmit, isLoading, updateImages } = useProductoCreate()
...
export default AdminProductoCreatePage